...
#define UBER_VERSION_STRING         "#version 320 es\n"
#define UBER_IMAGE_EXT_STRING       "#extension GL_OES_EGL_image_external_essl3 : require\n"
#define UBER_CAMERA_EXT_STRING      "#extension GL_OES_EGL_image_external_essl3 : require\n"
#define UBER_SUBSAMPLED_EXT_STRING  "#extension GL_QCOM_texture_foveated_subsampled_layout : require\n"
...
#define UBER_SUBSAMPLED_STRING      "#define SUPPORT_SUBSAMPLED\n"          // kWarpSubsampled = (1 << 9),
#define UBER_CAMERA_MONO_F16_STRING      "#define SUPPORT_CAMERA_MONO_F16\n"     // kWarpCameraImage = (1 << 10),
#define UBER_CAMERA_MONO_INT16_STRING    "#define SUPPORT_CAMERA_MONO_INT16\n"   // kWarpCameraImage = (1 << 10),
#define UBER_CAMERA_MONO_8_10BIT_STRING  "#define SUPPORT_CAMERA_MONO_8_10BIT\n" // kWarpCameraImage = (1 << 10),
#define UBER_CAMERA_COLOR_STRING         "#define SUPPORT_CAMERA_COLOR\n"        // kWarpCameraImage = (1 << 10),
#define UBER_CAMERA_COLOR_SWAP_STRING    "#define SUPPORT_CAMERA_COLOR_SWAP\n"   // kWarpCameraImage = (1 << 10),
...
// Support for color plane displays
#define UBER_COLOR_PLANE_STRING     "#define COLOR_PLANE_SUPPORT\n"         // Global. Not hooked to a flag
...
// Due to svrSetWarpMesh some of these meshes are now defined in sxrApi.h. 
...
enum svrWarpMeshArea
{
	...
	// Tracking Caemra versions (Tracking Camera Lens Distortion)
    kMeshLeft_Camera,   // 31
    kMeshRight_Camera,
    kMeshUL_Camera,
    kMeshUR_Camera,
...
struct SvrAsyncWarpResources
{
    ...
    Svr::SvrGeometry        occludeMeshGeom;
    Svr::SvrShader          occludeMeshShader;
    Svr::SvrShader          occludeMeshArrayShader;
