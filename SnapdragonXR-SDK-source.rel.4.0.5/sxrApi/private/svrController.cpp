...
//TODO: move this 
//-----------------------------------------------------------------------------
static void ResetControllerState(sxrControllerState* state)
//-----------------------------------------------------------------------------
{
    ::memset(state, 0, sizeof(sxrControllerState));
    state->rotation.w = 1;
}

//-----------------------------------------------------------------------------
static void TransformControllerState(sxrControllerState* state)
//-----------------------------------------------------------------------------
{
    sxrHeadPoseState head = sxrGetPredictedHeadPose(0);
...
//-----------------------------------------------------------------------------
SXRP_EXPORT sxrControllerState sxrControllerGetState(int controllerHandle, int controllerSpace)
//-----------------------------------------------------------------------------
{
    sxrControllerState controllerState;
