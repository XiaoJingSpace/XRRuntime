...
static inline sxrQuaternion svrQuatFromGlmQuat(const glm::fquat& fq)
{
    sxrQuaternion retQuat;
    memcpy(&retQuat.x, glm::value_ptr(fq), 4 * sizeof(float));
	return retQuat;
}

static inline sxrQuaternion svrQuatFromGlmVec4(const glm::vec4& fv)
{
    sxrQuaternion retQuat;
...
static inline glm::fquat  glmQuatFromSvrQuat(const sxrQuaternion& sq)
{
