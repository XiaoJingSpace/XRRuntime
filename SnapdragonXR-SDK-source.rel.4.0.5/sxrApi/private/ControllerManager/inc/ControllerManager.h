...
class ControllerManager {
    private:
        ...
        RingBuffer<sxrControllerState>* listOfControllers[MAX_CONTROLLERS];
        Svr::svrEventManager* eventManager;
        bool IsValid(int index);
        void CachePtr(int, RingBuffer<sxrControllerState>* ptr);
        void Clear();
    public:
    ...
    public:
        ...
        bool ControllerGetState(int handle, sxrControllerState* data);
