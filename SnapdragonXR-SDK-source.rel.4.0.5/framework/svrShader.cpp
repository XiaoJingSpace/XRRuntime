...
void SvrShader::SetUniformMat2(const char* name, const glm::mat2& matrix)
{
    SvrUniform  uniform;
...
void SvrShader::SetUniformMat2(int location, const glm::mat2& matrix)
{
    GL(glUniformMatrix2fv(location, 1, GL_FALSE, glm::value_ptr(matrix)));
}

void SvrShader::SetUniformMat2fv(const char* name, unsigned int count, const float *pData)
{
    SvrUniform  uniform;
    if (mUniformMap.Find(name, &uniform))
    {
...
void SvrShader::SetUniformMat2fv(int location, unsigned int count, const float *pData)
{
    GL(glUniformMatrix2fv(location, count, GL_FALSE, pData));
}

void SvrShader::SetUniformMat3(const char* name, const glm::mat3& matrix)
{
    SvrUniform  uniform;
    if (mUniformMap.Find(name, &uniform))
    {
...
void SvrShader::SetUniformMat3(int location, const glm::mat3& matrix)
{
    GL(glUniformMatrix3fv(location, 1, GL_FALSE, glm::value_ptr(matrix)));
}

void SvrShader::SetUniformMat4(const char* name, const glm::mat4& matrix)
{
    SvrUniform  uniform;
    if( mUniformMap.Find( name, &uniform ) )
    {
...
void SvrShader::SetUniformMat4(int location, const glm::mat4& matrix)
{
    GL(glUniformMatrix4fv(location, 1, GL_FALSE, glm::value_ptr(matrix)));
}

void SvrShader::SetUniformMat4fv(const char* name, unsigned int count, const float *pData)
{
    SvrUniform  uniform;
    if (mUniformMap.Find(name, &uniform))
    {
...
void SvrShader::SetUniformMat4fv(int location, unsigned int count, const float *pData)
{
    GL(glUniformMatrix4fv(location, count, GL_FALSE, pData));
}

void SvrShader::SetUniformVec4(const char* name, const glm::vec4& vector)
{
    SvrUniform uniform;
    if(mUniformMap.Find( name, &uniform))
    {
...
void SvrShader::SetUniformVec4(int location, const glm::vec4& vector)
{
    GL(glUniform4fv(location, 1, glm::value_ptr(vector)));
}

void SvrShader::SetUniformVec3(const char* name, const glm::vec3& vector)
{
    SvrUniform uniform;
    if (mUniformMap.Find(name, &uniform))
    {
...
void SvrShader::SetUniformVec3(int location, const glm::vec3& vector)
{
    GL(glUniform3fv(location, 1, glm::value_ptr(vector)));
}

void SvrShader::SetUniformVec2(const char* name, const glm::vec2& vector)
{
    SvrUniform uniform;
    if (mUniformMap.Find(name, &uniform))
    {
...
void SvrShader::SetUniformVec2(int location, const glm::vec2& vector)
{
