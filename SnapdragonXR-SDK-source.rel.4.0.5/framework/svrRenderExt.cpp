...
namespace Svr
{
    ...
    PFNEGLIMAGETARGETTEXSTORAGEEXTPROC      eglImageTargetTexStorageEXT = NULL;
    ...
    bool InitializeRenderExtensions()
    {
        ...
        eglImageTargetTexStorageEXT = (PFNEGLIMAGETARGETTEXSTORAGEEXTPROC)InitExtension("glEGLImageTargetTexStorageEXT");
