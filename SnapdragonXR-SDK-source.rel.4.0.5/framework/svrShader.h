...
namespace Svr
{
    ...
    public:
        ...
        void SetUniformMat2(int location, const glm::mat2& matrix);
        void SetUniformMat2fv(const char* name, unsigned int count, const float *pData);
        void SetUniformMat2fv(int location, unsigned int count, const float *pData);
        void SetUniformMat3(const char* name, const glm::mat3& matrix);
        void SetUniformMat3(int location, const glm::mat3& matrix);
        void SetUniformMat4(const char* name, const glm::mat4& matrix);
        void SetUniformMat4(int location, const glm::mat4& matrix);
        void SetUniformMat4fv(const char* name, unsigned int count, const float *pData);
        void SetUniformMat4fv(int location, unsigned int count, const float *pData);
        void SetUniformVec4(const char* name, const glm::vec4& vector);
        void SetUniformVec4(int location, const glm::vec4& vector);
        void SetUniformVec3(const char* name, const glm::vec3& vector);
        void SetUniformVec3(int location, const glm::vec3& vector);
        void SetUniformVec2(const char* name, const glm::vec2& vector);
        void SetUniformVec2(int location, const glm::vec2& vector);
