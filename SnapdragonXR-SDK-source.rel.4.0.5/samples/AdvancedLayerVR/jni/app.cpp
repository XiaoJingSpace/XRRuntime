...
AdvancedLayerApp::AdvancedLayerApp()
{
    mLastRenderTime = 0;
    mModelTexture = 0;
    mOverlayTexture = 0;
...
void AdvancedLayerApp::Initialize()
{
...
void AdvancedLayerApp::InitializeModel()
{
...
void AdvancedLayerApp::SubmitFrame()
{
...
void AdvancedLayerApp::RenderEye(Svr::SvrEyeId eyeId)
{
...
float AdvancedLayerApp::GetRotationAmount(float rotationRate)
{
...
void AdvancedLayerApp::Shutdown()
{
