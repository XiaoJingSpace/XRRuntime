...
import com.qualcomm.sxrapi.SxrApi.sxrQuaternion;
import com.qualcomm.sxrapi.SxrApi.sxrVector3;
...
import static com.qualcomm.svr.apps.photoViewer.svrView.sxrApiRenderer;
...
public class photoViewerRenderer implements svrView.svrRenderer {
    public photoViewerRenderer(Activity parentActivity, Context mContext) {
        ...
        rotationQuat = sxrApiRenderer.new sxrQuaternion();
    ...
    public void sphereDataInit() {
        ...
        sxrVector3 colorVec = sxrApiRenderer.new sxrVector3(1.0f, 1.0f, 1.0f);
    ...
    public sxrQuaternion rotationQuat;
}
