...
import com.qualcomm.sxrapi.SxrApi.sxrBeginParams;
import com.qualcomm.sxrapi.SxrApi.sxrEyeMask;
import com.qualcomm.sxrapi.SxrApi.sxrFrameParams;
import com.qualcomm.sxrapi.SxrApi.sxrHeadPoseState;
import com.qualcomm.sxrapi.SxrApi.sxrLayoutCoords;
import com.qualcomm.sxrapi.SxrApi.sxrPerfLevel;
import com.qualcomm.sxrapi.SxrApi.sxrTextureType;
import com.qualcomm.sxrapi.SxrApi.sxrTrackingMode;
import com.qualcomm.sxrapi.SxrApi.sxrWarpType;
import com.qualcomm.sxrapi.SxrApi.sxrDeviceInfo;
...
public class svrView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    //public static SvrApi sxrApiRenderer;
    ...
    private void init() {
        ...
        sxrApiRenderer = new SxrApi();
        mSvrFrameParams = sxrApiRenderer.new sxrFrameParams();
        mBeginParams = sxrApiRenderer.new sxrBeginParams(svrHolder.getSurface());
        mHeadPoseState = sxrApiRenderer.new sxrHeadPoseState();
        layoutCoords = sxrApiRenderer.new sxrLayoutCoords();
        Log.i(TAG, sxrApiRenderer.sxrGetVersion());
        Log.i(TAG, sxrApiRenderer.sxrGetXrServiceVersion());
        Log.i(TAG, sxrApiRenderer.sxrGetXrClientVersion());
        sxrApiRenderer.sxrInitialize(m_ParentActivity);
    }
    ...
    private class defaultConfigFrameParams implements configSvrFrameParams {
        public void setSvrFrameParams() {
            ...
            mSvrFrameParams.warpType = sxrWarpType.kSimple;
            ...
            sxrApiRenderer.sxrSetPerformanceLevels(sxrPerfLevel.kPerfMaximum, sxrPerfLevel.kPerfMaximum);
            sxrDeviceInfo deviceInfo = sxrApiRenderer.sxrGetDeviceInfo();
            int supportedMode = sxrApiRenderer.sxrGetSupportedTrackingModes();
            int trackingMode = sxrTrackingMode.kTrackingPosition.getTrackingMode();
            sxrApiRenderer.sxrSetTrackingMode(trackingMode);
            int trackedMode = sxrApiRenderer.sxrGetTrackingMode();
        }

        public void updatePerFrameParams() {
            mSvrFrameParams.frameIndex++;
            predictedTimeMs = sxrApiRenderer.sxrGetPredictedDisplayTime();
            mHeadPoseState = sxrApiRenderer.sxrGetPredictedHeadPose(predictedTimeMs);
            mSvrFrameParams.headPoseState = mHeadPoseState;
        }
    }
                    ...
                    if (svrEglCreateContext) {
                        ...
                        if (view != null) {
                            try {
                                ...
                                sxrApiRenderer.sxrBeginXr(m_ParentActivity, mBeginParams);
                    ...
                    }
                    {
                        ...
                        if (view != null) {
                            try {
                                ...
                                sxrApiRenderer.sxrSubmitFrame(m_ParentActivity, mSvrFrameParams);
                            } finally {
                                //Trace.traceEnd(Trace.TRACE_TAG_VIEW);
                            }
                        }
    ...
    public static SxrApi sxrApiRenderer;
    public static sxrFrameParams mSvrFrameParams;
    public static sxrHeadPoseState mHeadPoseState;
    public static sxrBeginParams mBeginParams;
    public static sxrLayoutCoords layoutCoords;
