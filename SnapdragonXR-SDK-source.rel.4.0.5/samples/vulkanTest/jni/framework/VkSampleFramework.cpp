...
bool VkSampleFramework::CheckInstanceExtensions()
{
    ...
    // We're looking for these 4 extensions
    VkBool32 surfaceExtFound            = 0;
    VkBool32 platformSurfaceExtFound    = 0;
    VkBool32 deviceProperties2ExtFound  = 0;
    ...
    for (uint32_t i = 0; i <numInstanceExtensions; i++)
    {
        ...
        {
            deviceProperties2ExtFound = 1;
            mInstanceExtensionNames[mEnabledInstanceExtensionCount++] = VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME;
        }
    ...
    if (!deviceProperties2ExtFound)
    {
        LOGE("vkEnumerateInstanceExtensionProperties failed to find the " VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME" extension.");
        return false;
    }
