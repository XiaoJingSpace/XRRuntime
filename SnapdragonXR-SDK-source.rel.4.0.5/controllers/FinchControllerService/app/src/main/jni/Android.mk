...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../jniLibs
LOCAL_C_INCLUDES += $(SXR_HOME)/sxrApi/public/
...
#jniLibs/libubeacon.so
#jniLibs/libftdi1.so jniLibs/libubeacon.so jniLibs/libusb-1.0.so
#LOCAL_SHARED_LIBRARIES := ubeacon ubeaconadsp chirpc_skel
