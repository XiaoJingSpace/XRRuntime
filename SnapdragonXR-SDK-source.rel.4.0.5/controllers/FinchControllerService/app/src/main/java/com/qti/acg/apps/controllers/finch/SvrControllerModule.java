...
public abstract class SvrControllerModule extends Service {
    ...
    public IBinder onBind(Intent intent) {
        ...
        return new IControllerInterface.Stub() {
            ...
            public void Start(int handle, String desc, ParcelFileDescriptor pfd, int fdSize, ParcelFileDescriptor qvrFd, int qvrFdSize) throws RemoteException {
                SvrControllerModule.this.ControllerStart(handle, desc, pfd, fdSize,qvrFd, qvrFdSize);
                Log.e(TAG, "Start " + " desc " +  desc + " pfd " + pfd + " fdSize " + fdSize);
            }
    ...
    protected abstract void ControllerStart(int handle, String desc, ParcelFileDescriptor pfd, int fdSize, ParcelFileDescriptor qvrFd, int qvrFdSize);
